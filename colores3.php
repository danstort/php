...
// $colorSeleccionado = (!empty(($_GET['color'])) && isset($_GET['color']) && in_array(($_GET['color']), $colores)) ? $_GET['color'] : "black";

if (!empty(($_GET['color'])) && isset($_GET['color']) && in_array(($_GET['color']), $colores)) {
    ...
    <section id="main">
        <header>
            ...
            <form name="calculator">
                ...
                <input type="textfield" name="ans" value=""  style="background-color:<?php echo $colorSeleccionado ?>">
                <br>
